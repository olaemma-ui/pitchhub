...
abstract class NetworkService {
  ...
  Future<Either<Failure, Response<T>>> getUri<T>(
    Uri uri, {
  ...
  Future<Either<Failure, Response<T>>> postUri<T>(
    Uri uri, {
    Map<String, dynamic>? headers,
  ...
  ///The  [headers] parameter is only passed when there's need to parse an header for th request
  //////The  [body] this is the request body for the endpoint called using this method
  Future<Either<Failure, Response<T>>> deletUri<T>(
    Uri uri, {
    Map<String, dynamic>? headers,
    Map<String, dynamic>? body,
    dynamic queryParameters,
  ...
  ///The  [headers] parameter is only passed when there's need to parse an header for th request
  //////The  [body] this is the request body for the endpoint called using this method
  Future<Either<Failure, Response<T>>> putUri<T>(
    Uri uri, {
    Map<String, dynamic>? body,
    Map<String, dynamic>? headers,
    dynamic queryParameters,
